      ...
      <section className="portal">
        <div className="container portal__inner">
          <div className="portal__copy">
            ...
            <Link to="/" className="btn btn--ghost">Crear cuenta gratis →</Link>
          </div>
          <div className="portal__form">
            <h3>Ingresa a tu cuenta</h3>
            <div className="form-group"><label>Número de documento</label><input type="text" placeholder="Ej. 1020304050" /></div>
            <div className="form-group"><label style={{display:'flex',justifyContent:'space-between'}}><span>Contraseña</span><a href="#" className="portal__recover">¿Olvidaste la tuya?</a></label><input type="password" placeholder="••••••••" /></div>
            <button className="btn btn--primary portal__submit">Ingresar al portal</button>
            <p className="portal__footer">¿No tienes cuenta? <Link to="/">Regístrate gratis</Link></p>
          </div>
        </div>
      </section>
      ...
      <section className="news">
        <div className="container">
          ...
          <div className="news-grid">
            {[{icon:'vaccine',tag:'Campaña',title:'Jornada de vacunación contra la influenza 2026',date:'18 ago 2026'},{icon:'brain',tag:'Bienestar',title:'Recursos de salud mental disponibles para ti',date:'15 ago 2026'},{icon:'card',tag:'Novedades',title:'Nueva app con telemedicina integrada',date:'10 ago 2026'}].map((n,i)=>(
