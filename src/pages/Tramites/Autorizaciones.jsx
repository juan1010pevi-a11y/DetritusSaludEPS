...
export default function Autorizaciones() {
  ...
  const handleSubmit = (event) => {
    ...
    setStatus('Datos validados. La consulta está lista para conectarse al sistema de autorizaciones.');
  };
