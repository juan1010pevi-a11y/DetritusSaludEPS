...
export default function AgendarCita() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setStatus(`Solicitud ${data.appointment.id} registrada. Un asesor confirmará la disponibilidad.`);
    } catch {
      setStatus('No fue posible registrar la cita. Verifica que Healthcare Service esté activo.');
    }
  };
        ...
        <div className="container appointment-layout">
          <form className="info-card appointment-form" onSubmit={handleSubmit}>
            ...
            <div className="form-row">
              ...
              <div className="form-group"><label htmlFor="appointment-document">Número de documento</label><input id="appointment-document" name="document" type="text" placeholder="1020304050" required /></div>
            </div>
            <div className="form-row">
              <div className="form-group"><label htmlFor="appointment-specialty">Especialidad</label><select id="appointment-specialty" name="specialty" defaultValue="" required><option value="" disabled>Selecciona una opción</option><option>Medicina general</option><option>Medicina interna</option><option>Pediatría</option><option>Odontología</option><option>Psicología</option></select></div>
            ...
            <div className="form-row">
              ...
              <div className="form-group"><label htmlFor="appointment-date">Fecha preferida</label><input id="appointment-date" name="date" type="date" required /></div>
            </div>
            <div className="form-row">
